...
| deletion.fxa_device_id |[uuid](https://mozilla.github.io/glean/book/user/metrics/uuid.html) |The FxA device id.  |[1](https://github.com/mozilla-mobile/firefox-ios/pull/7629#issuecomment-723312428)||never | |
...
| Name | Type | Description | Data reviews | Extras | Expiration | [Data Sensitivity](https://wiki.mozilla.org/Firefox/Data_Collection) |
| --- | --- | --- | --- | --- | --- | --- |
| app.opened_as_default_browser |[counter](https://mozilla.github.io/glean/book/user/metrics/counter.html) |Recorded when a preference is changed and includes the preference that changed as well as the value changed to recorded in the extra keys.  |[1](https://github.com/mozilla-mobile/firefox-ios/pull/7245)||2021-03-01 | |
